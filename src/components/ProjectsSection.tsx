      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center bg-white/5 rounded-3xl p-8 md:p-12 border border-white/10">
          ...
          <div className="space-y-6">
            ...
            <h3 className="text-4xl md:text-5xl font-bold font-display leading-tight">Teacup</h3>
            
            <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed">
              Teacup is a minimalist project management tool designed for creative hobbyists and small teams. It streamlines workflows by focusing on simplicity and visual clarity, allowing users to brew their best ideas without the clutter of traditional enterprise software. Built with Next.js and real-time collaboration features.
            </p>
